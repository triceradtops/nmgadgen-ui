...
export default function HistoryPage() {
    ...
    return (
        <div className="max-w-7xl mx-auto p-8 font-[family-name:var(--font-geist-sans)]">
            <header className="mb-12 border-b border-white/10 pb-8 flex justify-between items-center">
                ...
                <div className="flex gap-4">
                    <Input
                        ...
                        className="bg-black/50 border-white/10 text-white w-64"
                        onKeyDown={(e) => e.key === 'Enter' && fetchHistory()}
                    />
                    <Button onClick={fetchHistory} disabled={loading} className="bg-white text-black hover:bg-zinc-200">
